...
const Footer = () => {
  ...
  return (
    <footer className="mt-auto grid grid-cols-[100px_120px_120px_1fr_1fr] bg-primary p-[2%] text-xs text-footer-primary md:grid-cols-5 md:p-[3%] lg:p-[4%] xl:px-[8%] xl:text-sm">
