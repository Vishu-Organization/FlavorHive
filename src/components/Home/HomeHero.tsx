  ...
  return (
    <section id="hero" className="relative block h-96 overflow-hidden">
      ...
      <div className="absolute left-1/2 top-1/4 -translate-x-1/2 -translate-y-1/3 md:left-[3%] md:top-2/4 md:-translate-y-2/4 md:translate-x-0">
        <h2 className="max-w-[440px] text-center font-chronicle text-3xl font-semibold text-primary md:text-left md:text-xl lg:text-2xl xl:text-3xl 2xl:text-[40px] 2xl:leading-snug">
          Easy meal kits. <br />
          Quality ingredients.
          <br />
          Delivered to your door.
        </h2>
        <Button className="mx-auto mt-4 px-4 py-2 md:mx-0 xl:mt-5 xl:px-5 xl:py-3 2xl:mt-8 2xl:px-7 2xl:py-4">
          See Plans
        </Button>
      </div>
    </section>
