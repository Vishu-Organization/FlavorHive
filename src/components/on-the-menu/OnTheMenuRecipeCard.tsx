...
const OnTheMenuRecipeCard = ({
  ...
  return (
    <article className="flex w-64 flex-col items-stretch justify-between overflow-hidden rounded-md border border-gray-200 bg-gray-50 shadow-md transition-all duration-300 hover:border-gray-300 hover:no-underline hover:shadow-lg md:w-80 lg:w-72 xl:w-80">
